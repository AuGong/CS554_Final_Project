        ...
        <div class="col-sm-12 col-md-6 col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              />
              <h3 class="card-title">Want to help out more?</h3>
              <p class="card-text">
          ...
          <div class="card">
            <div class="card-body">
              <img
                ...
                alt="Cat lying down"
              />
              <h3 class="card-title">Why Adopt?</h3>
              <p class="card-text">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              />
              <h3 class="card-title">I Want to Donate</h3>
              <p class="card-text">Looking to donate but don't know where?</p>
              <a
